 ...
 */
final class Version20260224121907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `character` ADD description VARCHAR(255) DEFAULT NULL, ADD physique VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `character` DROP description, DROP physique');
